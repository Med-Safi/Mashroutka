...
public class CarController : Car
{
    ...
    [SerializeField] SelfDriving pathFollower =null;
    ...
    public override void Start()
    {
        ...
        if(isAIControlledCar)
        {
            //carModel.SetCarLabel(GameObject.GetUsername());
        }
        if(nitrous1 != null)
        {
    ...
    public Material[] GetCarBodyMaterial()
    {
    ...
    public void SetDistanceToNextCheckPoints(float distance)
    {
